namespace Web_gs_ZenFlow.Domain.Entities;
...
public class Usuario
{
    ...
    // Navegação
    public ICollection<Registro> Registros { get; private set; } = new List<Registro>();

    private Usuario() { }

    public Usuario(string nomeCompleto, string email, string senha, DateTime dataNascimento, string cpf, bool isGestor = false)
    {
